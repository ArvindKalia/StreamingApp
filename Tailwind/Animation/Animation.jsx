        ...
        >
          <div
            className={`
                    ...
                    `}
          >
            <div className="p-8 sm:p-16 w-full">{data[index].caption}</div>
          </div>
        </animated.div>
      </>
    );
                  ...
                  <>
                    <button
                      ...
                      style={{
                        ...
                        height: "5px",
                        background:
                          count === index ? "white" : "rgba(255,255,255,0.3",
                      }}
                    ></button>
                  </>
                );
...
export const Slider = ({ data, vertical = false }) => {
  ...
  const bind = useDrag(handleDrag, {
    bounds: {
      left: -(
        imageBound.width * data.length -
        (mainBound.width - imageBound.width / 2)
      ),
      right: 0,
      ...
      >
        ...
        <div
          className={`flex absolute ${
            vertical
              ? "w-full justify-center top-0 left-0"
              : "h-full items-center top-0 left-0"
          } `}
        >
          <button
            onClick={prev}
        ...
        <div
          className={`flex absolute ${
            vertical
              ? "w-full justify-center bottom-0 left-0"
              : "h-full items-center top-0 right-0"
          } `}
        >
          <button
            onClick={next}
