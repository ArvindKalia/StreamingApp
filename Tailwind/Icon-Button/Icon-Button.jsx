...
const sample={
    ...
    "error": "bg-red-600 textwhite shadow-lg",
    "warning": "bg-orange-600 text-orwhite shadow-lg",
    "success": "bg-green-600 text-gwhite shadow-lg",

    "t-primary": "text-teal-600 text-teal-600",
    "t-secondary": "text-blue-600 text-blue-600",
    "t-info": "text-cyan-600 text-cyan-600",
    "t-error": "text-red-600 text-red-600",
    "t-warning": "text-orange-600 text-orange-600",
    "t-success": "text-green-600 text-green-600",
