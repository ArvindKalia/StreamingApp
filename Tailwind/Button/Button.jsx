const sample={
    ...
    "t-primary": "text-teal-600 text-teal-600 rounded-sm px-4 py-2",
    "t-secondary": "text-blue-600 text-blue-600 rounded-sm px-4 py-2",
    "t-info": "text-cyan-600 text-cyan-600 rounded-sm px-4 py-2",
    "t-error": "text-red-600 text-red-600 rounded-sm px-4 py-2",
    "t-warning": "text-orange-600 text-orange-600 rounded-sm px-4 py-2",
    "t-success": "text-green-600 text-green-600 rounded-sm px-4 py-2",
